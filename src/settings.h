// clang-format off
	...
	*/
	// *****BUTTON*****        *****ACTION*****
	#define BUTTON_0_SHORT    CMD_NEXTTRACK // AUS AUS AUS AN
	#define BUTTON_1_SHORT    CMD_PREVTRACK // AUS AN AUS AUS
	#define BUTTON_2_SHORT    CMD_PLAYPAUSE // AUS AUS AN AUS
	#define BUTTON_3_SHORT    CMD_MEASUREBATTERY // DREHKNOPF DRUECKEN
	// #define BUTTON_4_SHORT    CMD_SEEK_BACKWARDS
	#define BUTTON_4_SHORT    CMD_STOP // AUS AUS AUS AUS
	// #define BUTTON_5_SHORT    CMD_SEEK_FORWARDS
	#define BUTTON_5_SHORT    CMD_NOTHING

	#define BUTTON_0_LONG     CMD_SEEK_FORWARDS // AUS AUS AUS AN FORWARD
	#define BUTTON_1_LONG     CMD_SEEK_BACKWARDS // AUS AN AUS AUS BACK
	#define BUTTON_2_LONG     CMD_REPEAT_TRACK // AUS AUS AN AUS  START
	#define BUTTON_3_LONG     CMD_SLEEPMODE // ROTARY LANGE DRUECKEN
	#define BUTTON_4_LONG     CMD_SLEEP_AFTER_END_OF_TRACK // AN AUS AUS AUS
	#define BUTTON_5_LONG     CMD_VOLUMEDOWN

	#define BUTTON_MULTI_01   CMD_VIRTUAL_RFID_CARD_01 // AUS AN AUS AN FORWARD/BACK zusammen
	#define BUTTON_MULTI_02   CMD_TELL_CURRENT_TIME // NEXT + PLAY
	#define BUTTON_MULTI_03   CMD_TOGGLE_BLUETOOTH_SOURCE_MODE // ROTARY + FORWARD -> Bluetooth schicken
	#define BUTTON_MULTI_04   CMD_VIRTUAL_RFID_CARD_10 // AN AUS AUS AN
	#define BUTTON_MULTI_05   CMD_NOTHING
	#define BUTTON_MULTI_12   CMD_TELL_IP_ADDRESS  // PREV + PLAY
	#define BUTTON_MULTI_13   CMD_TOGGLE_BLUETOOTH_SINK_MODE // ROTARY + BACKWARD: Bluetooth Empfangen
	#define BUTTON_MULTI_14   CMD_VIRTUAL_RFID_CARD_02 // STOP + ZUCMD_NOTHINGRUECK
	#define BUTTON_MULTI_15   CMD_NOTHING
	#define BUTTON_MULTI_23   CMD_TOGGLE_WIFI_STATUS // ROTARY + STARTSTOP
	#define BUTTON_MULTI_24   CMD_DIMM_LEDS_NIGHTMODE // AN AUS AN AUS STARTTOP MIT PLAY
	#define BUTTON_MULTI_25   CMD_NOTHING
	#define BUTTON_MULTI_34   CMD_TOGGLE_MODE // rotary + STOP /mode wechsel
	...
	// (optinal) Neopixel
		...
		constexpr float s_warningCriticalVoltage = 2.8;                 // If battery-voltage is <= this value, assume battery near-empty. Set to 0V to disable.
